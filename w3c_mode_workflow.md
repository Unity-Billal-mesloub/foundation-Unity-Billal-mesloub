...
Git branches as they relate to the "Deliverable Development Process" in Appendix A of the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement).

* Topic and Bugfix branches (Equal to the "Pre-Draft" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement))
* `working_draft` (Equal to the "Draft Deliverable" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement))
* `candidate_recommendation` (Equal to the "Working Group Approval" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement))
* `main` (Equal to the "Approved Deliverable" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement))

Pull requests opened from the `working_draft` branch to the `candidate_recommendation` branch are equal to the "Working Group Approval" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement).
Pull requests opened from the `candidate_recommendation` branch to the `main` branch are equal to the "Final Approval" in the [project charter](https://github.com/Unity-Billal-mesloub/foundation/blob/main/membership-participation-agreement).
